...
function generateHtmlContent() {
  const htmlContent = html`
    <section class="main-section">
      ...
      <p>
        It uses <a href="https://github.com/ayame113/ts-serve">Just-In-Time (JIT) transpiled TypeScript</a>, and <a href="https://developer.mozilla.org/en-US/docs/Web/Web_Components">Web Components</a>.
      </p>
      <p>Enjoy it!</p>
